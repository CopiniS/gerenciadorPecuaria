"""
Django settings for gestaoPecuaria project.
...
# Configuração para permitir o uso de JWT para autenticação no Django REST Framework
REST_FRAMEWORK = {
...
FRONTEND_URL = 'http://localhost:8080'  # Ajuste para a URL do seu frontend
