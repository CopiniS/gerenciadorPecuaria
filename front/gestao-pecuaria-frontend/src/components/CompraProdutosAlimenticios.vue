      ...
      <table class="table table-bordered">
        ...
        <tbody>
          <tr v-for="(compra, index) in compras" :key="index">
            ...
            <td>{{ compra.lote }}</td>
            <td>
              <button @click="editarCompra(compra)" class="btn-acoes btn-primary btn-sm" data-bs-toggle="modal"
                data-bs-target="#edicaoModal" data-bs-whatever="@mdo"><i class="fas fa-edit"></i></button>
              <button @click="confirmarExclusao(compra)" class="btn-acoes btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#confirmacaoExclusaoModal"><i
