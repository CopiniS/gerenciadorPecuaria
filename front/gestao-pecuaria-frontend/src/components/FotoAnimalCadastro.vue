        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                <button class="nav-link" :class="{ active: activeTab === 'cadastro' }" id="nav-cadastro-tab"
                    ...
                    aria-selected="false">Cadastro de Foto</button>
            </div>
        </nav>
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade" :class="{ 'show active': activeTab === 'aplicacoes' }" id="nav-vet"
                role="tabpanel" aria-labelledby="nav-vet-tab">
            </div>
            <div class="tab-pane fade show active" id="nav-cadastro" role="tabpanel" aria-labelledby="nav-cadastro-tab">
                <div class="table-container" id="cadastro" tabindex="-1" aria-labelledby="cadastroLabel"
                    aria-hidden="true">
                    ...
                    <form @submit.prevent="submitForm" class="form-foto">
                        <div class="mb-3 input-group mb-3-foto">
                            <span class="input-group-text" title="Data da Foto"><i
                                    class="fas fa-calendar-alt"></i></span>
                            <DateComponent type="text" :placeholder="dataPlaceholder" class="form-control" id="dataFoto"
                                autocomplete="off" v-model="formData.dataFoto" :class="{ 'is-invalid': !isDataValida }"
                                title="Data da Foto" @update:selectedDate="updateDataFoto" />
                        </div>
                        <div class="mb-3 input-group mb-3-foto">
                            <span class="input-group-text" title="Observações da Foto"><i
                        ...
                        <div class="button-group justify-content-end">
                            <button type="button" class="btn btn-secondary"
                                @click="selectTab('visualizacao')">Cancelar</button>
