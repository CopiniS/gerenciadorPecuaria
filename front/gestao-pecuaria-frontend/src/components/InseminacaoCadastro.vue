  ...
  <div class="background">
    <nav>
      <div class="nav nav-tabs" id="nav-tab" role="tablist">
        ...
        type="button" role="tab" aria-controls="nav-vet" aria-selected="true">Lista de Inseminacao</button>
        <button class="nav-link" :class="{ active: activeTab === 'cadastro' }" id="nav-cadastro-tab" @click="selectTab('cadastro')" 
        type="button" role="tab" aria-controls="nav-cadastro" aria-selected="false">Cadastro de Inseminacao</button>
      </div>
    </nav>
    <div class="tab-content" id="nav-tabContent">
      <div class="tab-pane fade" :class="{ 'show active': activeTab === 'inseminacoes' }" id="nav-vet" role="tabpanel" aria-labelledby="nav-vet-tab">
      </div>
      ...
      if (this.validarFormulario()) {
        try {
          ...
          if (response.status === 201) {
            ...
            alert('Erro ao cadastrar inseminacao. Tente novamente mais tarde.');
          }
        } catch (error) {
