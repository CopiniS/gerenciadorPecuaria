    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Cadastro de Propriedade</h5>
        </div>
          ...
          <form @submit.prevent="submitForm" @keydown="checkEnter">
              <div class="mb-3 input-group">
                ...
                <div class="button-group justify-content-end">
                    <button type="button" class="btn btn-secondary" @click="voltaEscolhas">Cancelar</button>
...
//REQUISIÇÕES AO BANCO DE DADOS---------------------------------------------------------------------------------------------------------------------
    async buscarCidadesPorEstado(estadoId) {
        this.loadingInicialCidade = true;
        try {
