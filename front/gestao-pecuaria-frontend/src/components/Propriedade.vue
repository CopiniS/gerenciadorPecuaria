      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Edição de Propriedade</h5>
          </div>
          <div class="modal-body">
            <form id="formProdutor" @submit.prevent="submitEditForm">
              <div class="mb-3 input-group">
                <span class="input-group-text"><i class="fas fa-user-tag"></i></span>
                <input v-model="formData.nome" type="text" class="form-control" placeholder="Nome" id="nomeEditar">
              </div>
              <div class="mb-3 input-group">
                <span class="input-group-text"><i class="fas fa-map-marker-alt"></i></span>
                <input v-model="formData.endereco" type="text" class="form-control" placeholder="Endereço" id="enderecoEditar">
              </div>
              <div class="mb-3 input-group">
                <span class="input-group-text"><i class="fas fa-flag"></i></span>
                <select v-model="formData.estado" class="form-select" id="estadoEditar" required @change="buscarCidadesPorEstado($event.target.value)">
              ...
              <div class="mb-3 input-group">
                ...
                <input v-model="formData.latitude" type="text" class="form-control" placeholder="Latitude" id="latitudeEditar">
              </div>
              <div class="mb-3 input-group">
                <span class="input-group-text"><i class="fas fa-globe"></i></span>
                <input v-model="formData.longitude" type="text" class="form-control" placeholder="Longitude" id="longitudeEditar">
              </div>
            </form>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" @click="voltar()">Cancelar</button>
            <button type="button" class="btn btn-primary" @click="submitEditForm">Salvar Alterações</button>
          </div>
        </div>
      </div>
    </div>
