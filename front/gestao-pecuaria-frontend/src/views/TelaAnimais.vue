        ...
        >
          ...
          <div class="col-auto d-flex align-items-center">
            ...
            <DateRangePicker
              ...
              :startDate="filtro.dataNascimentoInicio"
              :endDate="filtro.dataNascimentoFim"
              @update:startDate="(val) => (filtro.dataNascimentoInicio = val)"
      ...
      <div>
        <div class="table-container">
          <div class="button-container">
            ...
            <button
              @click="mostrarPopupEscolhaRelatorio"
              type="button"
              class="btn btn-success"
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr v-for="(animal, index) in animais" :key="index">
                ...
                <td
                  :class="{
                    'status-Vivo': animal.status === 'Vivo',
                    'status-morto': animal.status === 'morto',
                    'status-doente': animal.status === 'doente',
                  }"
                >
                  {{ animal.status }}
                </td>
                <td>
                  <div class="d-flex justify-content-center button-group">
                    <button
                      @click="acessarVisualizacao(animal)"
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div v-if="tipoRelatorio === 'resumido'">
                  <RelatorioPdf
                    titulo="Relatório de Animal Resumido"
                    :cabecalho="[
                ...
                <div v-if="tipoRelatorio === 'detalhado'">
                  <RelatorioPdf
                    titulo="Relatório de Animal Detalhado"
                    :cabecalho="[
                      'Nome do produtor: ' + nomeProdutor,
                      'Propriedade: ' + propriedadeAtualNome,
                    ]"
                    ...
                    :dados="
                      animais.map((animal) => [
                        ...
                        animal.sexo,
                        animal.piquete.nome,
                        animal.racaPredominante?.nome,
                        animal.racaObservacao,
                        animal.brincoPai,
                        animal.brincoMae,
                      ])
                    "
                ...
                <div v-if="tipoRelatorio === 'compraAnimais'">
                  <!-- Relatório de Compra de Animais -->
                  <RelatorioPdf
                    v-if="tipoRelatorio === 'compraAnimais'"
                    titulo="Relatório de Compra de Animais"
                    :cabecalho="[
                      'Nome do produtor: ' + nomeProdutor,
                      'Propriedade: ' + propriedadeAtualNome,
                    ]"
                    ...
                    :dados="
                      animaisComprados.map((animal) => [
                        animal.brinco,
                        formatarData(animal.dataCompra),
                        formatarValor(animal.valorCompra),
                      ])
                    "
                    :mostrarSoma="true"
                  />
  ...
  computed: {
    ...
    animaisComprados() {
      return this.animais.filter(
        (animal) => animal.dataCompra && animal.valorCompra
      );
    },
  },
  methods: {
    ...
    aplicarFiltro() {
      this.animais = this.animaisDaApi.filter((animal) => {
        ...
        return (
          new Date(animal.dataNascimento) >=
            new Date(this.filtro.dataNascimentoInicio || "1970-01-01") &&
          new Date(animal.dataNascimento) <=
            new Date(this.filtro.dataNascimentoFim || "9999-12-31") &&
