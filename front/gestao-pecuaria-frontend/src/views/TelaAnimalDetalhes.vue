<template>
  <div class="background">
    ...
    <div class="animal-view">
      ...
      <SkeletonListagem v-if="loadingAnimal || loadingOcorrencia || loadingFoto" />
  ...
  methods: {
    ...
    async fetchAnimal(animalId) {
      try {
        const response = await api.get(
          `http://127.0.0.1:8000/animais/animal/${animalId}/`
        );
    ...
    preencheFormAnimal() {
      ...
      if (this.animal.racaPredominante) {
        this.formDataAnimal.racaPredominante =
          this.animal.racaPredominante.nome;
      }
    },
