        ...
        >
          <div class="col-auto d-flex align-items-center">
            ...
            <DateRangePicker
              ...
              :startDate="filtro.dataGastoInicio"
              :endDate="filtro.dataGastoFim"
  ...
  methods: {
    ...
    async apagarGasto() {
      try {
        const response = await api.delete(
          `http://127.0.0.1:8000/gastos/${this.formData.id}/`,
          {}
        );
    ...
    aplicarFiltro() {
      this.gastos = this.gastosDaApi.filter((gasto) => {
        ...
        return (
          new Date(gasto.dataGasto) >=
            new Date(this.filtro.dataGastoInicio || "1970-01-01") &&
          new Date(gasto.dataGasto) <=
            new Date(this.filtro.dataGastoFim || "9999-12-31") &&
