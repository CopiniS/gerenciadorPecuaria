    ...
    <nav>
      <div class="nav nav-tabs" id="nav-tab" role="tablist">
        <button class="nav-link active" id="nav-vet-tab" data-bs-toggle="tab" data-bs-target="#nav-vet" type="button"
          role="tab" aria-controls="nav-vet" aria-selected="true">Lista de Inseminações</button>
      </div>
    </nav>
    ...
    <div class="d-flex align-items-start table-container flex-column">
      ...
      <form @submit.prevent="aplicarFiltro" @keyup.enter="aplicarFiltro" class="row g-3 align-items-center"
        ...
        <div class="col-auto d-flex align-items-center">
          ...
          <DateRangePicker ref="dateRangePicker" class="input-consistente" :startDate="filtro.dataInseminacaoInicio"
            :endDate="filtro.dataInseminacaoFim" @update:startDate="val => filtro.dataInseminacaoInicio = val"
        ...
        <div class="col-auto d-flex align-items-center">
          ...
          <input type="text" class="form-control input-consistente" id="identificadorTouro"
