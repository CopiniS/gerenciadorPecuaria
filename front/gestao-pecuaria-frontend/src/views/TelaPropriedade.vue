          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr v-for="(propriedade, index) in propriedades" :key="index">
                ...
                <td>
                  <button
                    v-if="propriedadeAtualId == propriedade.id"
                    @click="acessarEdicao(propriedade)"
                  ...
                  <button
                    v-if="propriedadeAtualId == propriedade.id"
                    @click="confirmarExclusao(propriedade)"
                    class="btn-acoes btn-sm"
                  ...
                  <button
                    v-if="propriedadeAtualId != propriedade.id"
                    @click="trocaPropriedade(propriedade.id)"
                    class="btn-acoes btn-sm"
                    title="Trocar Propriedade"
                  >
